...
class SavingsAccount(Account):
    def __init__(self, account_type,account_number, balance, interest, minimum_limit):
    ...
    def print_details(self):
        super().print_details()
        print(f"Interest Rate: {self.interest}, Minimum Limit: ${self.minimum_limit}")
...
class  FixedDepositAccount(Account):
    def __init__(self, account_type,account_number, balance, maturity_limit):
        super().__init__(account_number, balance)
    ...
    def withdraw(self, amount):
        if self.maturity>=self.maturity_limit:
            super().withdraw(amount)
        else:
